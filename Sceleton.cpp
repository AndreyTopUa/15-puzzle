                     ...
                     int       nCmdShow)//вид окна
{
	...
	win.hIcon=LoadIcon(hInst, (LPCSTR)IDI_ICON1);//иконка, идентификатор иконки ID_APPLIKATION (LPCSTR)IDI_ICON1
	...
	hwnd=CreateWindow(name,"Пятнашки с автосборкой",WS_OVERLAPPEDWINDOW/*|WS_VISIBLE*/,50,50,
